...
function Gallery() {
    ...
    <main style={{backgroundColor:"#fff"}}>
      ...
      <Container className="sectionMargin" >
        ...
        <b>Sometimes words are not enough.</b> These photos showcase the exceptional lifestyle possibilities at The Oasis Homes. Our resort-style senior retirement community is the only Life Plan Community in The Sylmar, renowned for its welcoming residents, well-appointed accommodations, and elegant amenities. It is senior living as it should be.
        </Typography>
        <br/> <br/>
        <Typography color="#333" sx={{fontFamily:"acumin-pro,\"sans-serif\"",fontWeight:100,fontSize:"1.3rem"}}>
