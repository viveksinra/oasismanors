...
if(loading){
 ...
 return (
    <main style={{background:"#fff",boxShadow:"rgba(100, 100, 111, 0.2) 0px 7px 29px 0px",borderRadius:8,padding:10}} className='center'>
           <Button href="https://www.cdss.ca.gov/cdssweb/entres/forms/English/LIC622.PDF" download variant="contained" >Download Form LIC LIC622 </Button>
