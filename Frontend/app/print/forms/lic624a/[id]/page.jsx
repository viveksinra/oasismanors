...
export function LIC624A({params}) {
...
if(loading){
 ...
 return (
    <main style={{background:"#fff",boxShadow:"rgba(100, 100, 111, 0.2) 0px 7px 29px 0px",borderRadius:8,padding:10}} className='center'>
           <Button href="https://test.rcfesoftware.com/report_templates/1/lic624a%20death%20report.pdf" download variant="contained" >Download Form LIC LIC624A </Button>
