...
function CreativeLiving() {
    ...
    <main style={{backgroundColor:"#fff"}}>
      ...
      <Container className="sectionMargin" >
        ...
        <Typography color="#333" sx={{fontFamily:"acumin-pro,\"sans-serif\"",fontWeight:100,fontSize:"1.3rem",lineHeight:"2.4rem"}}>
        The Canterbury offers a beautiful setting, incomparable service, and superb amenities to support your <br/> physical, emotional, and intellectual needs, encouraging growth, self-expression, and enjoyment.
        </Typography>
        ...
        <Grid item xs={12}>
        <Typography color="#333" sx={{fontFamily:"acumin-pro,\"sans-serif\"",fontWeight:100,fontSize:"1.3rem",lineHeight:"2.4rem"}}>
        Read <Link style={{color:"#00a2c2",fontWeight:600,textDecoration:"underline"}} href="/">testimonials</Link>  from those already enjoying the Creative Living lifestyle at The Canterbury.
        </Typography>
        </Grid>
        <Grid item xs={12}>
        ...
        The Academy draws on the insights and direction of a volunteer group of Canterbury resident advisors who assist in its development and oversight. Creative Living mindfully celebrates the talents and life experiences of those who live at The Canterbury Residents are encouraged to be facilitators and teachers.
        </Typography><br/>
