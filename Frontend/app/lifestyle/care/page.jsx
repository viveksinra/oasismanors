    ...
    <main style={{backgroundColor:"#fff"}}>
      ...
      <Container className="sectionMargin" >
        ...
        <Grid container spacing={2}>
            ...
            <Typography color="#082952" gutterBottom sx={{fontSize:{xs:"24px",md:"46px"},lineHeight:"60px", marginTop:"30px", fontFamily: "AdequateLight,Helvetica Neue,Helvetica,\"sans-serif\""}}>Assisted Living with Joy!</Typography>
            <Typography color="#333" sx={{fontFamily:"acumin-pro,\"sans-serif\"",fontWeight:400,fontSize:"1.3rem",lineHeight:"1.8rem"}}>
            Your <strong>Joy of Living</strong> care program provides the assistance you need through a flexible range of services, including:
            </Typography> 
                <ul style={{listStyle:"none",marginTop:"30px",marginLeft:"30px"}}>
                    {joyCare.map((l,i)=><li className="choiceList" key={i}>{l}</li>)}
                </ul>
                <br/>
            <Typography color="#333" sx={{fontFamily:"acumin-pro,\"sans-serif\"",fontWeight:400,fontSize:"1.3rem",lineHeight:"1.8rem"}}>
