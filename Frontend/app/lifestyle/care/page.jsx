    ...
    <main style={{backgroundColor:"#fff"}}>
      ...
      <Container className="sectionMargin" >
        ...
        <Grid container spacing={2}>
            ...
            The Canterbury provides a broad spectrum of exceptional senior care and services designed to meet your needs, now and in the future.
            </Typography> <br/> 
        ...
        <Typography color="#333" sx={{fontFamily:"acumin-pro,\"sans-serif\"",fontWeight:100,fontSize:"1.3rem",lineHeight:"2rem"}}>
        Our Team Members are professionally trained and dedicated to providing heartfelt care with dignity and respect. As a continuing care retirement community, The Canterbury takes pride in creating a family atmosphere. Our Team Members play an important role, which is why their tenure with ECS can be measured in terms of decades, not years.
        </Typography><br/>
        <Typography color="#333" sx={{fontFamily:"acumin-pro,\"sans-serif\"",fontWeight:100,fontSize:"1.3rem",lineHeight:"2rem"}}>
      ...
      <Container>
        ...
        {teamCare.map((c,i)=><Grid item key={i} xs={12}>
            ...
            <Grid container spacing={4}>
             ...
             <Typography color="#333" sx={{fontFamily:"acumin-pro,\"sans-serif\"",fontWeight:300,fontSize:"20px",lineHeight:"1.8rem"}}>
             From independent to assisted living in the South Bay, choosing the right level of care and accommodation is an important decision. If you have any questions, would like more information, clarification on a specific topic, or even arrange to drop by for a visit, don’t hesitate to call or <Link style={{color:"#00a2c2",fontWeight:500}} href="/contact">Contact Us.</Link>
                </Typography>
             </Grid>
             <Grid item xs={12} md={3}/>
        </Grid>
