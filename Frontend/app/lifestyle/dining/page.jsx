...
function Dining() {
    ...
    <main style={{backgroundColor:"#fff"}}>
      ...
      <Container className="sectionMargin" >
        ...
        At The Canterbury, exceptional gourmet dining is part of your daily experience.<br/> Our award-winning Culinary Team understands the unique needs of seniors.<br/> Flavor, nutrition, and service are at the heart of everything we do. All meals are:
        </Typography>
        ...
        <ul style={{listStyle:"none",marginTop:"30px"}}>
            ...
            <li style={{listStyleType:"disc",fontSize: "1.2rem",lineHeight:"1.8",fontFamily:"acumin-pro,\"sans-serif\"",fontWeight:300,}}>The Canterbury is guided by the Monterey Bay Aquarium Seafood Watch to help us select seafood <br/> that is responsibly managed, whether wild or farmed, causing little harm to habitats or wildlife.</li>
