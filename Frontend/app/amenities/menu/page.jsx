...
import { FcDebt,FcCalendar,FcNext,FcPrevious  } from "react-icons/fc";
...
const [week3Data] = useState([{breakfast:{day:"Monday",slot1:["Apple Juice","Oatmeal","Cottage Cheese","Cup","Whole Wheat","Toast","Margarine","Jelly / Jam","2% Milk","Coffee"],slot2:["Orange Juice","Assorted Cold","Cereal","Peanut Butter","White Toast","Hot Tea"]}, lightMeal:{day:"Monday",slot1:["Soda Crackers","Country Bean &","Veg Soup","Shaker Pork on","Bun","Creamed Corn","Mandarin","Oranges","Coffee"],slot2:["Herbed Oatmeal","Marinated","Zucchini","Whole Wheat","Bread","Hash Brown","Potatoes","Margarine","Broken Glass","Jellies","2% Milk","Hot Tea"]},mainMeal:{day:"Monday",slot1:["Chalet Chicken","w/Sauce","Diced Beets","Parisienne","Potatoes","Margarine","Frosted Vanilla","Cake","Coffee"],slot2:["Spaghetti & Meat","Sauce","Light Caesar","Salad","Cantaloupe","Wedges","2% Milk","Hot Tea","Garlic Bread"]} },
  ...
  {breakfast:{day:"Friday",slot1:["Oatmeal","Pancakes","Sausage Link","Margarine","Jelly / Jam","2% Milk","Coffee"],slot2:["Orange Juice","Prune Juice","Assorted Cold","Cereal","Peanut Butter","Whole Wheat","Toast","White Toast","Hot Tea"]}, lightMeal:{day:"Friday",slot1:["LS Cream of","Turkey Soup","Soda Crackers","Tuna Salad on","Wheat","Relish Plate","Pineapple Slices","Coffee"],slot2:["Grilled Cheese on","Wheat","Caesar Salad","Margarine","Lemon Mousse","2% Milk","Hot Tea"]},mainMeal:{day:"Friday",slot1:["Liver & Onions","Seasoned Green","Peas","Whipped","Potatoes","Margarine","Banana Cake","Coffee","Wheat Roll"],slot2:["Herb Baked","Chicken Breast","Squash Medley","Roasted New","Potatoes","Mixed Berries","2% Milk","Hot Tea"],}},
       ...
       <Tabs value={menuTab} onChange={(e,v)=>setMenutab(v)} aria-label="Menu Tab">
        ...
        <Grid container>
          ...
          <ul style={{listStyle:"none", padding:"8px 4px 4px 8px"}}>
            {m.breakfast.slot1.map((l,j)=> <li key={j}><Typography variant="body2">{l} </Typography> </li> )} <Divider sx={{marginTop:"5px",marginBottom:"5px"}}/> 
            {m.breakfast.slot2.map((l,j)=> <li key={j}><Typography variant="body2">{l} </Typography> </li> )}
            </ul>
             </Grid>)}
            ...
            <ul style={{listStyle:"none", padding:"8px 4px 4px 8px"}}>
            {m.lightMeal.slot1.map((l,j)=> <li key={j}><Typography variant="body2">{l} </Typography> </li> )} <Divider sx={{marginTop:"5px",marginBottom:"5px"}}/> 
            {m.lightMeal.slot2.map((l,j)=> <li key={j}><Typography variant="body2">{l} </Typography> </li> )}
            </ul>
             </Grid>)}
             <Grid item xs={12}><br/> </Grid>
            ...
            <ul style={{listStyle:"none", padding:"8px 4px 4px 8px"}}>
            {m.mainMeal.slot1.map((l,j)=> <li key={j}><Typography variant="body2">{l} </Typography> </li> )} <Divider sx={{marginTop:"5px",marginBottom:"5px"}}/> 
            {m.mainMeal.slot2.map((l,j)=> <li key={j}><Typography variant="body2">{l} </Typography> </li> )}
            </ul>
             </Grid>)}
        </Grid>
        <br/>
