    ...
    <main style={{backgroundColor:"#fff"}}>
      ...
      <Container className="sectionMargin" >
        ...
        <ul style={{listStyle:"none",marginTop:"30px",marginLeft:"30px"}}>
            ...
            <br/> <br/>
            <Typography color="#333" sx={{fontFamily:"acumin-pro,\"sans-serif\"",fontWeight:100,fontSize:"1.3rem",lineHeight:"1.8rem"}}>
            Within our welcoming workplace culture, you will make a difference and be appreciated every day, by both your coworkers and the people who call our communities home. ECS provides competitive salaries and benefits, plus security, flexibility and wellness opportunities, along with engaging employee programs offering recognition, fulfillment and fun.
            </Typography>
            <br/> <br/>
            ...
            All ECS communities have been honored with the 2022 Workplace Excellence Award by Align. Are you a caring person who is looking for an incredible place to work? We are looking for people like you!
            </Typography>
            <br/> <br/>
        ...
        <Typography color="#333" sx={{fontFamily:"acumin-pro,\"sans-serif\"",fontWeight:100,fontSize:"1.3rem",lineHeight:"1.8rem"}}>
        Volunteerism is a cornerstone of the ECS philosophy and culture. It inspires our approach to Creative Living and the work of our numerous clubs and committees.
        <br/>  <br/>
